...
namespace LODSwap
{
	...
	namespace Terrain
	{
		struct BuildMeshFileName
		{
			...
			static inline std::uint64_t id = 31948;
		...
		struct BuildDiffuseTextureFileName
		{
			...
			static inline size_t size = 0x39;
			static inline std::uint64_t id = 31949;
		...
		struct BuildNormalTextureFileName
		{
			...
			static inline size_t size = 0x39;
			static inline std::uint64_t id = 31950;
	...
	namespace Object
	{
		struct BuildMeshFileName
		{
			...
			static inline size_t size = 0x39;
			static inline std::uint64_t id = 31957;
		...
		struct BuildDiffuseTextureAtlasFileName
		{
			...
			static inline std::uint64_t id = 31958;
		...
		struct BuildNormalTextureAtlasFileName
		{
			...
			static inline size_t size = 0x1F;
			static inline std::uint64_t id = 31959;
	...
	namespace Tree
	{
		struct BuildMeshFileName
		{
			...
			static inline size_t size = 0x39;
			static inline std::uint64_t id = 31960;
		...
		struct BuildTextureFileName
		{
			...
			static inline size_t size = 0x1F;
			static inline std::uint64_t id = 31961;
		...
		struct BuildTypeListFileName
		{
			...
			static inline size_t size = 0x1F;
			static inline std::uint64_t id = 31962;
